...
namespace UnityORM
{
	...
	public class SqliteDatabase
	{
		...
		[DllImport("__Internal", EntryPoint = "sqlite3_errcode")]
		private static extern int sqlite3_errcode(IntPtr db);
		
		[DllImport("__Internal", EntryPoint = "sqlite3_extended_errcode")]
		private static extern int sqlite3_extended_errcode(IntPtr db);
